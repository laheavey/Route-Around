/** ---------- ORDER OF OPERATIONS ---------- **/
-- 1️⃣: Copy & paste lines 6-147 into your database app, execute
-- 2️⃣: Import data from file './GTFS-data/GreenLineTrips.txt' to your gtfs_trips table
-- 3️⃣: Copy/paste/execute lines 157-167
-- 4️⃣: Import data from file './GTFS-data/GreenLineShapes.txt' to your gtfs_shapes table
-- 5️⃣: Copy/paste/execute lines 178-181

/** ---------- 1️⃣ STEP ONE: BASE TABLES + DATA, NO DEPENDENCIES ---------- **/
...
CREATE TABLE "poi_details" (
    ...
    INSERT INTO "poi_details"
        ...
        VALUES
        ('St. Paul Union Depot','https://www.uniondepot.org/wp-content/uploads/2020/01/OutsideFrontHero1lowres-scaled.jpg','214 4th St E, St Paul MN', -93.08614014373347, 44.94743766037045,
...
CREATE TABLE "gtfs_routes" (
    ...
    INSERT INTO "gtfs_routes" 
        ("id", "route_long_name", "route_short_name", "route_name", "route_desc", "route_url", "route_color", "route_text_color",  "agency_id", "route_type", "route_sort_order")
        VALUES
...
/** ---------- 1️⃣ STEP ONE CONT.: TABLES W/ DEPENDENCIES ---------- **/
-- Sources for details
...
/** ---------- 2️⃣ STEP TWO: IMPORT DATA ---------- **/

    -- IMPORT DATA FROM FILE './GTFS-data/GreenLineTrips.txt'


/** ---------- 3️⃣ STEP THREE: COPY/PASTE/EXECUTE ---------- **/
...
/** ---------- 4️⃣ STEP FOUR: IMPORT DATA ---------- **/

    -- IMPORT DATA FROM FILE './GTFS-data/GreenLineShapes.txt'


/** ---------- 5️⃣ STEP FIVE: COPY/PASTE/EXECUTE ---------- **/
